...
Tasks currently slack bot can perform
***************

* Check the application url and if it is down then raise ParerDuty immediately
* Scan all the query in channel and provide the appropriate wiki document
* Raise jira ticket in an automated fashion as soon as any issue/request is raised
